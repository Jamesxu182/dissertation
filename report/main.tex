...
\newcommand{\degree}{M.Sc Future Networked Systems} % Your degree name, this is used in the title page and abstract
\newcommand{\typeofthesis}{Dissertation} % dissertation, Final Year Project, report, etc.
\newcommand{\authorname}{Yifan Xu} % Your name, this is used in the title page and PDF stuff
%% Comment out the next line if you don't want your ID to appear
\newcommand{\authorid}{17306250} % Your ID
\newcommand{\keywords}{Blockchain, Mobile data offloading, Wifi Roaming} % Keywords for your thesis
